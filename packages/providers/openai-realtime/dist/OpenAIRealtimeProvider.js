...
export class OpenAIRealtimeProvider {
        ...
        try {
            ...
            switch (msg.type) {
                ...
                case 'response.audio_transcript.delta':
                    this.setChatStatus(this.hasHeardFirstGreeting ? 'speaking' : 'starting');
     ...
     */
    handleAssistantTranscript(delta) {
        const newMessage = {
            id: uuidv4(),
            role: 'assistant',
            text: delta,
    ...
    updateEphemeralUserMessage(partial) {
